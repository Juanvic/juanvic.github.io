const Curriculum = () => {
  return (
    <div className="mx-auto relative duration-300 hover:-rotate-0 transform-[rotate3d(1,-1,1,60deg)] group border border-sky-900 overflow-hidden rounded-2xl h-52 w-72 bg-sky-800 p-5 flex flex-col items-start gap-4">
      <div className="text-gray-50">
        <span className="font-bold text-5xl">Juan Almeida</span>
