...
export default function About() {
  return (
    ...
    <div className="flex flex-col justify-center items-center max-w-2xl mx-auto p-4 h-screen">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Sobre mim</h1>
      <p className="text-base font-normal text-gray-600 dark:text-gray-300 leading-relaxed">
